...
* `1.13.0`, `1.13`, `latest` ([7.2/debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.13.0/7.2/debian/Dockerfile))
* `1.13.0-php7.1`, `1.13-php7.1`, `php7.1` ([7.1/debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.13.0/7.1/debian/Dockerfile))
* `1.13.0-php7.2`, `1.13-php7.2`, `php7.2` ([7.2/debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.13.0/7.2/debian/Dockerfile))

### Alpine

* `1.13.0-alpine`, `1.13-alpine`, `alpine` ([7.2/alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.13.0/7.2/alpine/Dockerfile))
* `1.13.0-php7.1-alpine`, `1.13-php7.1-alpine`, `php7.1-alpine` ([7.1/alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.13.0/7.2/alpine/Dockerfile))
* `1.13.0-php7.2-alpine`, `1.13-php7.2-alpine`, `php7.2-alpine` ([7.2/alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.13.0/7.2/alpine/Dockerfile))
