...
* `1.41.4`, `1.41` ([7.4/debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.41.4/7.4/debian/Dockerfile))
* `1.41.4-php7.2`, `1.41-php7.2`, `php7.2` ([7.2/debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.41.4/7.2/debian/Dockerfile))
* `1.41.4-php7.3`, `1.41-php7.3`, `php7.3` ([7.3/debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.41.4/7.3/debian/Dockerfile))
* `1.41.4-php7.4`, `1.41-php7.4`, `php7.4` ([7.4/debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.41.4/7.4/debian/Dockerfile))

### Alpine

* `alpine` ([7.4/alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/master/7.4/alpine/Dockerfile))
* `1.41.4-alpine`, `1.41-alpine`, ([7.4/alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.41.4/7.4/alpine/Dockerfile))
* `1.41.4-php7.2-alpine`, `1.41-php7.2-alpine`, `php7.2-alpine` ([7.2/alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.41.4/7.2/alpine/Dockerfile))
* `1.41.4-php7.3-alpine`, `1.41-php7.3-alpine`, `php7.3-alpine` ([7.3/alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.41.4/7.3/alpine/Dockerfile))
* `1.41.4-php7.4-alpine`, `1.41-php7.4-alpine`, `php7.4-alpine` ([7.4/alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.41.4/7.4/alpine/Dockerfile))
