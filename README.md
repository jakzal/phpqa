...
* `1.105.0`, `1.105`, `1.105.0-debian`, `1.105-debian` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.105.0/Dockerfile))
* `1.105.0-php8.1`, `1.105-php8.1`, `php8.1-debian`, `php8.1` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.105.0/Dockerfile))
* `1.105.0-php8.2`, `1.105-php8.2`, `php8.2-debian`, `php8.2` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.105.0/Dockerfile))
* `1.105.0-php8.3`, `1.105-php8.3`, `php8.3-debian`, `php8.3` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.105.0/Dockerfile))

### Alpine

* `alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/master/Dockerfile))
* `1.105.0-alpine`, `1.105-alpine`, ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.105.0/Dockerfile))
...
* `1.105.0-php8.2-alpine`, `1.105-php8.2-alpine`, `php8.2-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.105.0/Dockerfile))
* `1.105.0-php8.3-alpine`, `1.105-php8.3-alpine`, `php8.3-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.105.0/Dockerfile))
