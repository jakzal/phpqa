...
* `1.96.1`, `1.96`, `1.96.1-debian`, `1.96-debian` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.96.1/Dockerfile))
* `1.96.1-php8.1`, `1.96-php8.1`, `php8.1-debian`, `php8.1` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.96.1/Dockerfile))
* `1.96.1-php8.2`, `1.96-php8.2`, `php8.2-debian`, `php8.2` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.96.1/Dockerfile))
* `1.96.1-php8.3`, `1.96-php8.3`, `php8.3-debian`, `php8.3` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.96.1/Dockerfile))

### Alpine

* `alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/master/Dockerfile))
* `1.96.1-alpine`, `1.96-alpine`, ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.96.1/Dockerfile))
* `1.96.1-php8.1-alpine`, `1.96-php8.1-alpine`, `php8.1-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.96.1/Dockerfile))
* `1.96.1-php8.2-alpine`, `1.96-php8.2-alpine`, `php8.2-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.96.1/Dockerfile))
* `1.96.1-php8.3-alpine`, `1.96-php8.3-alpine`, `php8.3-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.96.1/Dockerfile))
