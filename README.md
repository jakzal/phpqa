...
* `1.83.5`, `1.83`, `1.83.5-debian`, `1.83-debian` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.83.5/Dockerfile))
* `1.83.5-php8.0`, `1.83-php8.0`, `php8.0-debian`, `php8.0` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.83.5/Dockerfile))
* `1.83.5-php8.1`, `1.83-php8.1`, `php8.1-debian`, `php8.1` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.83.5/Dockerfile))
* `1.83.5-php8.2`, `1.83-php8.2`, `php8.2-debian`, `php8.2` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.83.5/Dockerfile))

### Alpine

* `alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/master/Dockerfile))
* `1.83.5-alpine`, `1.83-alpine`, ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.83.5/Dockerfile))
* `1.83.5-php8.0-alpine`, `1.83-php8.0-alpine`, `php8.0-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.83.5/Dockerfile))
* `1.83.5-php8.1-alpine`, `1.83-php8.1-alpine`, `php8.1-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.83.5/Dockerfile))
* `1.83.5-php8.2-alpine`, `1.83-php8.2-alpine`, `php8.2-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.83.5/Dockerfile))
