...
* `1.87.0`, `1.87`, `1.87.0-debian`, `1.87-debian` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.87.0/Dockerfile))
* `1.87.0-php8.0`, `1.87-php8.0`, `php8.0-debian`, `php8.0` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.87.0/Dockerfile))
* `1.87.0-php8.1`, `1.87-php8.1`, `php8.1-debian`, `php8.1` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.87.0/Dockerfile))
* `1.87.0-php8.2`, `1.87-php8.2`, `php8.2-debian`, `php8.2` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.87.0/Dockerfile))

### Alpine

* `alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/master/Dockerfile))
* `1.87.0-alpine`, `1.87-alpine`, ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.87.0/Dockerfile))
* `1.87.0-php8.0-alpine`, `1.87-php8.0-alpine`, `php8.0-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.87.0/Dockerfile))
* `1.87.0-php8.1-alpine`, `1.87-php8.1-alpine`, `php8.1-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.87.0/Dockerfile))
* `1.87.0-php8.2-alpine`, `1.87-php8.2-alpine`, `php8.2-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.87.0/Dockerfile))
