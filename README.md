...
* `1.92.5`, `1.92`, `1.92.5-debian`, `1.92-debian` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.92.5/Dockerfile))
* `1.92.5-php8.0`, `1.92-php8.0`, `php8.0-debian`, `php8.0` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.92.5/Dockerfile))
* `1.92.5-php8.1`, `1.92-php8.1`, `php8.1-debian`, `php8.1` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.92.5/Dockerfile))
* `1.92.5-php8.2`, `1.92-php8.2`, `php8.2-debian`, `php8.2` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.92.5/Dockerfile))

### Alpine

* `alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/master/Dockerfile))
* `1.92.5-alpine`, `1.92-alpine`, ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.92.5/Dockerfile))
* `1.92.5-php8.0-alpine`, `1.92-php8.0-alpine`, `php8.0-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.92.5/Dockerfile))
* `1.92.5-php8.1-alpine`, `1.92-php8.1-alpine`, `php8.1-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.92.5/Dockerfile))
* `1.92.5-php8.2-alpine`, `1.92-php8.2-alpine`, `php8.2-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.92.5/Dockerfile))
