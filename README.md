...
* `1.88.3`, `1.88`, `1.88.3-debian`, `1.88-debian` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.88.3/Dockerfile))
* `1.88.3-php8.0`, `1.88-php8.0`, `php8.0-debian`, `php8.0` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.88.3/Dockerfile))
* `1.88.3-php8.1`, `1.88-php8.1`, `php8.1-debian`, `php8.1` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.88.3/Dockerfile))
* `1.88.3-php8.2`, `1.88-php8.2`, `php8.2-debian`, `php8.2` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.88.3/Dockerfile))

### Alpine

* `alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/master/Dockerfile))
* `1.88.3-alpine`, `1.88-alpine`, ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.88.3/Dockerfile))
* `1.88.3-php8.0-alpine`, `1.88-php8.0-alpine`, `php8.0-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.88.3/Dockerfile))
* `1.88.3-php8.1-alpine`, `1.88-php8.1-alpine`, `php8.1-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.88.3/Dockerfile))
* `1.88.3-php8.2-alpine`, `1.88-php8.2-alpine`, `php8.2-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.88.3/Dockerfile))
