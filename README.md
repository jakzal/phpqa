...
* `1.75.2`, `1.75`, `1.75.2-debian`, `1.75-debian` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.75.2/Dockerfile))
* `1.75.2-php7.4`, `1.75-php7.4`, `php7.4-debian`, `php7.4` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.75.2/Dockerfile))
* `1.75.2-php8.0`, `1.75-php8.0`, `php8.0-debian`, `php8.0` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.75.2/Dockerfile))
* `1.75.2-php8.1`, `1.75-php8.1`, `php8.1-debian`, `php8.1` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.75.2/Dockerfile))

### Alpine

* `alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/master/Dockerfile))
* `1.75.2-alpine`, `1.75-alpine`, ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.75.2/Dockerfile))
* `1.75.2-php7.4-alpine`, `1.75-php7.4-alpine`, `php7.4-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.75.2/Dockerfile))
* `1.75.2-php8.0-alpine`, `1.75-php8.0-alpine`, `php8.0-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.75.2/Dockerfile))
* `1.75.2-php8.1-alpine`, `1.75-php8.1-alpine`, `php8.1-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.75.2/Dockerfile))
