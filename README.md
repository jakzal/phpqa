...
* `1.109.7`, `1.109`, `1.109.7-debian`, `1.109-debian` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.109.7/Dockerfile))
* `1.109.7-php8.2`, `1.109-php8.2`, `php8.2-debian`, `php8.2` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.109.7/Dockerfile))
* `1.109.7-php8.3`, `1.109-php8.3`, `php8.3-debian`, `php8.3` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.109.7/Dockerfile))

### Alpine

* `alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/master/Dockerfile))
* `1.109.7-alpine`, `1.109-alpine`, ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.109.7/Dockerfile))
* `1.109.7-php8.2-alpine`, `1.109-php8.2-alpine`, `php8.2-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.109.7/Dockerfile))
* `1.109.7-php8.3-alpine`, `1.109-php8.3-alpine`, `php8.3-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.109.7/Dockerfile))
