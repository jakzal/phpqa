...
* `1.60.0`, `1.60`, `1.60.0-debian`, `1.60-debian` ([debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.60.0/debian/Dockerfile))
* `1.60.0-php7.3`, `1.60-php7.3`, `php7.3-debian`, `php7.3` ([debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.60.0/debian/Dockerfile))
* `1.60.0-php7.4`, `1.60-php7.4`, `php7.4-debian`, `php7.4` ([debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.60.0/debian/Dockerfile))
* `1.60.0-php8.0`, `1.60-php8.0`, `php8.0-debian`, `php8.0` ([debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.60.0/debian/Dockerfile))

### Alpine

* `alpine` ([alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/master/alpine/Dockerfile))
* `1.60.0-alpine`, `1.60-alpine`, ([alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.60.0/alpine/Dockerfile))
* `1.60.0-php7.3-alpine`, `1.60-php7.3-alpine`, `php7.3-alpine` ([alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.60.0/alpine/Dockerfile))
* `1.60.0-php7.4-alpine`, `1.60-php7.4-alpine`, `php7.4-alpine` ([alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.60.0/alpine/Dockerfile))
* `1.60.0-php8.0-alpine`, `1.60-php8.0-alpine`, `php8.0-alpine` ([alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.60.0/alpine/Dockerfile))
