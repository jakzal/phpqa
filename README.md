...
* `1.111.0`, `1.111`, `1.111.0-debian`, `1.111-debian` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.111.0/Dockerfile))
* `1.111.0-php8.2`, `1.111-php8.2`, `php8.2-debian`, `php8.2` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.111.0/Dockerfile))
* `1.111.0-php8.3`, `1.111-php8.3`, `php8.3-debian`, `php8.3` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.111.0/Dockerfile))

### Alpine

* `alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/master/Dockerfile))
* `1.111.0-alpine`, `1.111-alpine`, ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.111.0/Dockerfile))
* `1.111.0-php8.2-alpine`, `1.111-php8.2-alpine`, `php8.2-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.111.0/Dockerfile))
* `1.111.0-php8.3-alpine`, `1.111-php8.3-alpine`, `php8.3-alpine` ([Dockerfile](https://github.com/jakzal/phpqa/blob/v1.111.0/Dockerfile))
