...
* `1.14.2`, `1.14`, `latest` ([7.2/debian/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.14.2/7.2/debian/Dockerfile))
...
* `1.14.2-alpine`, `1.14-alpine`, `alpine` ([7.2/alpine/Dockerfile](https://github.com/jakzal/phpqa/blob/v1.14.2/7.2/alpine/Dockerfile))
